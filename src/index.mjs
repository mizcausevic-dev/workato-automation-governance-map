...
const PRODUCT = {
  "repo": "workato-automation-governance-map",
  "vendor": "Workato",
  "title": "automation governance map",
  "domain": "Integration Automation",
  "audience": "IT leaders, RevOps, business systems teams, and integration owners",
  "problem": "Integration automation creates hidden operational dependencies when recipes, owners, error paths, and business outcomes are not connected.",
  "workflow": "The product maps automation recipes to owners, control gaps, downstream systems, failure posture, and remediation decisions.",
  "business": "Leaders can separate high-value automation from brittle workflow sprawl and focus platform investment.",
  "technical": "Synthetic integration lanes are scored deterministically and rendered into a static governance brief.",
  "integration": "Workato recipes, connectors, jobs, error handling, owners, and downstream business systems.",
  "keywords": [
    "Workato",
